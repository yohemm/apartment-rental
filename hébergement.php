...
<body>
	...
	<div id="content">
		...
		<p class="litle">*Ce formulaire est juste à titre informatif, <a href="contacts.php">veuillez nous contacter afin d'obtenir des informations supplémentaires.</a></p>
		</div>
		<?php }else{
